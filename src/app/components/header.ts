...
@Component({
  selector: 'app-header',
  template: `
    <header class="sticky top-0 z-50 bg-gradient-to-r border-b shadow-md backdrop-blur-sm from-primary-500/10 via-white/95 to-secondary-500/10 dark:from-primary-900/20 dark:via-gray-900/95 dark:to-secondary-900/20 border-gray-200/50 dark:border-gray-800/50 animate-fade-in">
      <div class="px-4 mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center space-x-3 animate-slide-in-right">
            <div class="flex justify-center items-center w-10 h-10 bg-gradient-to-br rounded-xl transition-all duration-500 transform from-primary-500 to-secondary-500 dark:from-primary-600 dark:to-secondary-600 shadow-glow hover:shadow-glow-secondary animate-pulse-slow hover:scale-105">
            ...
            <div>
              <h1 class="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary-500 via-secondary-500 to-accent-500 dark:from-primary-400 dark:via-secondary-400 dark:to-accent-400 animate-gradient">Cover Letter Generator</h1>
